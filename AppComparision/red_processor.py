...
# 常量定义
INPUT_DIR = "/Users/mac/PycharmProjects/AppComparision/pythonProject2/processed_data/red/platform_data"
INTERIM_DIR = "/Users/mac/PycharmProjects/AppComparision/pythonProject2/processed_data/red/platform_top_500_data"
AI_OUTPUT_DIR = "/Users/mac/PycharmProjects/AppComparision/pythonProject2/processed_data/red/ai_cleaned_data"
...
FILE_CONFIGS = {
    'cream': {
        'filename': 'cream.xlsx',
        'nrows': 500,
        'columns': {'商品名称': 'product', '商品价格': 'price'}
    },
    'lotion': {
        'filename': 'lotion.xlsx',
        'nrows': 500,
        'columns': {'商品名称': 'product', '商品价格': 'price'}
    },
    'mask': {
